    ...
    data: [
      {
        name: "Frozen in Time",
        description:
          "Play with the hues of colors and bring your imagination on to the canvas ! Showcase your creativity to the world of watercolors and create unique artwork to flaunt your talent. \nTHEME: 'Life as a ROBOT' ",
      ...
      },
      {
        name: "Kwest",
        description:
          "Presenting 'KWEST', an exciting event with the objective of promoting the development, diffusion, and enjoyment of art among students. This unique competition is crafted to ignite the imaginative sparks within students, offering them a dynamic platform to articulate their emotions through 'Best Out of Waste' \nThe competition shall be based on the theme 'Retro Recreation: A Resurgence of the Vintage Era.'",
      ...
      },
      {
        name: "Instant-O-Fie",
        description:
          " 'Faces of the Fest' is an exploration of the human element within KIITFEST. From the excitement of the attendees to the dedication of the participants, this theme seeks to freeze moments that define the exhilarating fest experience.",
      ...
      },
      {
        ...
        description:
          "Where do you fit in the tapestry of existence? Explore belonging in all its shades at Chitra Vichitra, KIIT Film Society's thought-provoking short film festival.",
      ...
      },
      {
        name: "Biz Tech Quiz",
        description:
          "Think you know the nuts and bolts of technology as well as the ebb and flow of business? Let's put that to the test! Presenting the 'Biz-Tech Quiz', where the sharp-witted meet the tech-savvy. It's not just about what's in the books; it's about connecting the pixels to the big picture.\nSo, if you're up to date with your Musk and your market cap, join us at the Biz-Tech Quiz. It's where business acumen meets tech expertise, and where your sharp insights could earn you the title of the Biz-Tech Maestro!",
      ...
      },
      {
        name: "Antakshari",
        description:
          "Antakshari is a popular musical game that originated in India. The game involves participants taking turns singing songs based on a specific theme or the ending syllable or word of the previous participant's song or war of random melodies between teams with various rules imposed.",
      ...
      },
      {
        ...
        imageUrl:
          "https://i.ibb.co/H2ybH4b/ZARA-NACHKE-DIKHA-Without-Registration.png",
        venue: "T.B.A.",
        memberType: "SOLO_OR_GROUP",
        type: "CULTURAL",
        category: "DANCE",
