          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="w-full h-full flex flex-col space-y-6">
              <div className="w-full relative">
                ...
                /> */}
                <div className="absolute left-[10px] text-slate-800 bottom-[10px]">
                  <CiUser size={25} />
                </div>
              ...
              <div className="w-full relative">
                ...
                /> */}
                <div className="absolute left-[10px] text-slate-800 bottom-[9px]">
              ...
              <div className="w-full relative">
                ...
                /> */}
                <div className="absolute left-[10px] text-slate-800 top-[13%]">
