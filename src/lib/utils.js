  ...
  const data = {
    ...
    <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
      ...
      <div style="text-align: center;">
        <a href="https://www.kiitfest.org/api/auth/confirm?code=${verificationCode}" style="background-color: #1a1a1a; color: #fff; padding: 10px 20px; border-radius: 5px; text-decoration: none;">Verify Email</a>
      </div>
