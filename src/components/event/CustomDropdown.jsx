...
export const CustomDropdown = ({
  ...
  useEffect(() => {
    const closeOtherDropdowns = (event) => {
      if (
        isOpen &&
        event.target.getAttribute("data-dropdown-toggle") !== label
      ) {
        closeDropdown();
      }
    };
        ...
        >
          ...
          {label === "Technical Event Category" ? (
            <>
              ...
              >
                <path
                  d="M12.3729 0H0.62706C0.0712317 0 -0.211926 0.671194 0.186592 1.06972L6.0595 6.94267C6.30071 7.18388 6.69922 7.18388 6.94054 6.94267L12.8134 1.06972C13.2119 0.671194 12.9287 0 12.3729 0Z"
                  fill="url(#paint0_linear_784_456)"
                />
                <defs>
                  <linearGradient
                    id="paint0_linear_784_456"
                    x1="6.49998"
                    y1="0"
                    x2="6.49998"
                    y2="7.12358"
            ...
            {options.map((option) => (
              <li key={option}>
                <button
                  ...
                  className="block px-4 py-2 w-full text-left duration-300 hover:bg-gray-200 dark:hover:bg-gray-600 dark:hover:text-white"
                >
                  {option}
                </button>
              </li>
